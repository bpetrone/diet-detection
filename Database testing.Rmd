...
What species are shared between metaproteomic, metabarcoding, and menu datasets (including only Mon-Thurs menu??)
...
# Quick checks
sum(plot.df$dna) # Should be 81
sum(plot.df$protein) # Should be 158
sum(plot.df$menu) # Should be 151
```
...
# pdf(here('results', 
#          'QC',
#          paste0(plotID, '_Taxa Euler diagram across methods, with counts.pdf')),
#     height = 4, width = 4)
