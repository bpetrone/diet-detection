...
db$scientific_name[db$scientific_name == 'Amaranthus cruentus'] <- 'Amaranthus hybridus subsp. cruentus'
``` 
...
fs <-
     here('data', 'raw',
          'NewDataForDavidLab_DB2.1Search_Workflow2.0') %>%
...
#           here('data', 'processed',
#                '20210408_Internal taxonomy table nodes.csv'))
...
# saveRDS(ps.protein, here('data', 'processed', 'phyloseq', '20210408_ps_mp.rds'))
```
