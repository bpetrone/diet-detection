...
```{r}
# Metabarcoding
# Note that tax_glom removes taxa that are NA at the glommed level by default
tax_table(ps.mb) <- 
...
---Think this is the transition point between new and old code---
...
# However, want to select only those that are plant-based (only failed samples from trnL, not 12SV5). Use taxonomy to judge:
taxtab.plants <- 
