...
There are `r ntaxa(ps.menu.12)` recorded in the menu in the 2 days prior to each sample, `r ntaxa(ps.mb)` detected by metabarcoding, and `r ntaxa(ps.protein)` detected by metaproteomics.
