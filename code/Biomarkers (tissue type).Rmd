...
```{r eval = FALSE}
# Filter based on "delta1" and "delta2" variables embedded in metaproteomic 
# phyloseq
ps.menu <-  
     ps.menu %>% 
     prune_samples(sample_names(.) %in% c(sample_data(ps.protein)$delta1,
                                          sample_data(ps.protein)$delta2),
                   .) %>% 
