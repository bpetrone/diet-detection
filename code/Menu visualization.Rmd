...
gplots::heatmap.2(
     as.matrix(melt.wide),
     # dendrogram = 'both',
     distfun = dist(as.matrix(melt.wide, method = 'binary')),
     Rowv = menu.dendro,
     labRow = labels(menu.dendro), # Pull ordering from dendrogram
     RowSideColors = subj.colors[gsub(labels(menu.dendro),
                                      pattern= '_.*',
                                      replacement = '')],
     Colv = ifsac.d,
