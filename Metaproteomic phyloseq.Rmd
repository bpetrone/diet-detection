...
Not sure I understand the rationale behind this: is it a sanity check (i.e. it should not happen)? 
...
proteins.df %>% 
     ...
     arrange(desc(n))
```
Looks like a substantial portion:

```{r}
4238/11880
```

Try this again when I can more readily group by species?
